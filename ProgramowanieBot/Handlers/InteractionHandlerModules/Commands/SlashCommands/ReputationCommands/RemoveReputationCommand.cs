...
public class RemoveReputationCommand(IServiceProvider serviceProvider, ConfigService config) : ApplicationCommandModule<SlashCommandContext>
{
            ...
            MinValue = 1)] long reputation)
    {
        ...
        return InteractionCallback.Message($"**{config.Emojis.Success} {string.Format(config.Interaction.ReputationCommands.ReputationRemovedResponse, user, reputation)}**");
    }
